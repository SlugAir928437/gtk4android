...
/* AKEYCODE_KEYBOARD_BACKLIGHT_* were added in Android 14 (API 34);
 * NDK r25c only ships keycodes up to API 33, so define them manually.
 * (values 305/306/307 from AOSP keycodes.h, API 34+) */
#ifndef AKEYCODE_KEYBOARD_BACKLIGHT_DOWN
#define AKEYCODE_KEYBOARD_BACKLIGHT_DOWN 305
#define AKEYCODE_KEYBOARD_BACKLIGHT_UP 306
#define AKEYCODE_KEYBOARD_BACKLIGHT_TOGGLE 307
#endif
